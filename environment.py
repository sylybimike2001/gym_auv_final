...
class BaseEnvironment(gym.Env, ABC):
    ...
    def __init__(self, env_config, test_mode=False, render_mode='2d', verbose=False):
        ...
        self.rng = None
        self.seed(0)  # self.seed() # Thomas 03.08.21 deterministic seeding for fair plots.
        ...
        if self.render_mode == '2d' or self.render_mode == 'both':
            ...
            print(self._viewer2d)
            self.viewer2d = self._viewer2d
    ...
    def reset(self, save_history=True):
        ...
        #if self.rng is None:
        #    self.seed()
        # Thomas 03.08.21 -- commented out to avoid reseeding to random
    ...
    def step(self, action:list) -> (np.ndarray, float, bool, dict):
        ...
        info['location'] = self.vessel.position
    ...
    def seed(self, seed=None):
        ...
        self.rng, seed = seeding.np_random(8)  # Thomas 04.08.21 deterministic seeding
        return [seed]
